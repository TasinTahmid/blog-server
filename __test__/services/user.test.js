...
//             jest.spyOn(userDTO, "Register").mockReturnValue(mockUser);
//             jest.spyOn(userRepo, "createUser").mockResolvedValue(mockCreatedUser);
...
//             // Assert
//             expect(userService.register(username, email, password)).resolves.toBe(mockToken);
//         });
...
//                 password: "mock-password",
//             };
//             const mockError = new Error("User already exists by this username.");

//             jest.spyOn(userRepo, "getUserByUsername").mockResolvedValue(mockUser);
//             jest.spyOn(userRepo, "getUserByEmail").mockResolvedValue(null);
//             jest.spyOn(bcrypt, "genSalt").mockReturnValue(mockSalt);
//             jest.spyOn(bcrypt, "hash").mockReturnValue(password);
//             jest.spyOn(userDTO, "Register").mockReturnValue(mockUser);
...
//             // Act & Assert
//             expect(userService.register(username, email, password)).rejects.toThrow(mockError);
//         });
...
//             jest.spyOn(userDTO, "Login").mockResolvedValue(mockUser);
//             jest.spyOn(userRepo, "getUserByEmail").mockResolvedValue(mockUser);
...
//             // Assert
//             expect(userService.login(email, password)).resolves.toBe(mockToken);
//         });
...
//             // Act & Assert
//             expect(userService.login(email, password)).rejects.toThrow(mockError);
//         });
...
//             jest.spyOn(userDTO, "UpdateUserById").mockResolvedValue(mockUpdateData);
//             jest.spyOn(userRepo, "updateUserById").mockResolvedValue(mockUpdatedUser);
...
//             // Assert
//             expect(
//                 userService.updateUserById(id, loggedInUserId, oldPassword, newPassword)
...
//             jest.spyOn(userRepo, "getUserById").mockResolvedValue(mockUser);
//             jest.spyOn(userRepo, "deleteUserById").mockResolvedValue(mockDeletedUser);

//             // Act
//             await userService.deleteUserById(id, loggedInUserId);

//             // Assert
//             expect(userService.deleteUserById(id, loggedInUserId)).resolves.toBe(mockDeletedUser);
//         });
...
//             // Act & Assert
//             expect(userService.deleteUserById(id, loggedInUserId)).rejects.toThrow(mockError);
//         });
